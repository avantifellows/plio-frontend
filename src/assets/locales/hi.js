export default {
    ...
    table: {
      ...
      search: {
        ...
        no_plios_found: {
          ...
          description:
            "कृपया चिंता न करें। वर्तनी की दोबारा जाँच करने का प्रयास करें या यहां तक ​​कि प्रकाशण ​​कि स्थिति के आधार पर खोज करें (प्रारूप/प्रकाशित)",
        },
      },
      buttons: {
  ...
  login: {
    heading: "वीडियो इंटरएक्टिव बनाएं",
    sub_headings: {
      interactive: {
        title: "इंटरैक्टिव यूट्यूब वीडियो",
        description:

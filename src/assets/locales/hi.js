    ...
    editor: {
      ...
      item_editor: {
        buttons: {
          ...
          add_image: {
            disbaled: "सवाल पे चित्र डालने के लिए क्लिक करें",
            enabled: "प्लायो के प्रकाशित होने के बाद आप चित्र नहीं दाल सकते",
          },
          update_image: {
            disbaled: "सवाल के चित्र को हटाने या बदलने के लिए क्लिक करें",
            enabled:
              "प्लायो के प्रकाशित होने के बाद आप चित्र को हटाना या अपडेट करना मन है",
          },
      ...
      home: "होम पे जाएँ",
      preview:
        "प्लायो का पूर्व दर्शन करें और देखें की ये आपके दर्शकों को कैसा दिखेगा",
      copy_draft_link:
        "अपनी टीम के साथ इस प्रारूप प्लायो का बाटने के लिए ये लिंक कॉपी करें",
      analyze: "इस प्लायो के दर्शकों का विश्लेषण करने के लिए क्लिक करें",

...
export function sendLogToDiscord(message, workspaceId) {
  ...
  const webhookPayload = {
    webhook_url:
      "https://discord.com/api/webhooks/1308380999587205142/Hhl6KeKDisGiV39DL4J0wNpoy46fuy6OUKFIpkfdxjKh0u8NVhEF6sktMuLHovYN8jGG",
    message: message,
  };
  ...
  return axios
    ...
    .catch((error) => {
      ...
      return {
        success: false,
        error: `Failed to send to Discord: ${error.message}`,
      };
    });
}

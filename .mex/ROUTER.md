...
- Playwright scaffold plus `auth-google-login`, `sso-learner-entry`, `creator-golden-path`, `creator-share-embed`, `creator-duplicate`, `creator-download-report`, `learner-golden-playback`, and `learner-resume` E2E journeys run locally with `npm run test:e2e`; `npm run seed:e2e` idempotently provisions their backend fixtures

**Not yet built:**
- The remaining inventoried Playwright E2E journey and CI orchestration are not implemented yet

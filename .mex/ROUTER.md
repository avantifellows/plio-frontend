...
- Playwright scaffold plus `auth-google-login`, `sso-learner-entry`, and `creator-golden-path` E2E journeys run locally with `npm run test:e2e`; `npm run seed:e2e` idempotently provisions their backend fixtures

**Not yet built:**
- The other 6 inventoried Playwright E2E journeys and CI orchestration are not implemented yet

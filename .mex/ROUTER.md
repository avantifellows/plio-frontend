...
- Playwright scaffold plus `auth-google-login`, `sso-learner-entry`, `creator-golden-path`, and `creator-share-embed` E2E journeys run locally with `npm run test:e2e`; `npm run seed:e2e` idempotently provisions their backend fixtures

**Not yet built:**
- The other 5 inventoried Playwright E2E journeys and CI orchestration are not implemented yet

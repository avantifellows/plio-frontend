...
8. The API Dashboard opens, click **Credentials** on the left Nav and switch to the **OAuth Consent Screen** tab — select **External** and provide an application name and an optional logo.
